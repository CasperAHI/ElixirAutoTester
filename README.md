...
In order to dock the listener simply call "BTS.accept(9000)" (it could be any port 9000 is just a placeholder)
...
The server is set such that the client does not need to send the tree everytime or ever since the server will memorice it.
